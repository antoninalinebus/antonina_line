...
if(isset($_POST['edit']) && $_POST['process']=="edit_user"){
  $edit_user = edit_settings($connection, $_POST);
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="settings.php"><i class="fa-solid fa-gear"></i> Alert Level Settings</a>
    ...
    <div class="right-content">
        <div style="overflow-x:auto;">
            <table>
              ...
              <?php 
              $sql = mysqli_query($connection, "SELECT * FROM settings");
              ...
              <tr>
                ...
                <td>$alert_level</td>
                <td>
                    <button onclick='editData(\"$id\", \"$alert_level\")' id='edit' data-bs-toggle='modal' data-bs-target='#edits'><i class='fa-solid fa-pen'></i></button>
                </td>                       
              </tr>
              ";
              }
            ...
            <div class="modal-body">
              <div class="modal-body">
                ...
                <div class="md-form">
                  ...
                  <input type="number" required id="alert_level" name="alert_level" class="form-control validate">
                </div>
              </div>
            </div>
